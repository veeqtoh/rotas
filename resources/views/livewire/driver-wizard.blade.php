                ...
                <ul id="addUserStepFormProgress" class="mb-3 step step-sm step-icon-sm step-inline step-item-between mb-md-5">
                    ...
                    <li class="step-item {{ $currentStep == 3 ? 'active' : '' }}">
                        <a class="step-content-wrapper" href="#!">
                            ...
                            <div class="step-content">
                                <span class="step-title">Emmergency contacts</span>
                            </div>
                        </a>
                    </li>
                    ...
                    <li class="step-item {{ $currentStep == 4 ? 'active' : '' }}">
                        <a class="step-content-wrapper" href="#!">
                            ...
                            <div class="step-content">
                                <span class="step-title">Certifications</span>
                            </div>
                        </a>
                    </li>
                ...
                <div id="addUserStepFormContent">
                    ...
                    <div id="step-2" class="card card-lg {{ $currentStep == 2 ? 'active' : '' }}" style="{{ $currentStep != 2 ? 'display: none;' : '' }}">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row mb-4">
                                <label for="locationLabel-tomselected" class="col-sm-3 col-form-label form-label" id="locationLabel-ts-label">Location</label>

                                <div class="col-sm-9">
                                    <!-- Select -->
                                    <div class="tom-select-custom mb-4">
                                        <select class="js-select form-select tomselected" id="locationLabel" tabindex="-1" hidden="hidden">
                                            <option
                                                value="AL"
                                        ...
                                        <div class="ts-control js-select form-select single plugin-change_listener plugin-hs_smart_position plugin-dropdown_input" tabindex="0">
                                            <div class="items ts-input full has-items">
                                                <span class="d-flex align-items-center item" data-value="AL">
                                                    <img class="avatar avatar-xss avatar-circle me-2" src="assets/vendor/flag-icon-css/flags/1x1/al.svg" alt="Albania Flag" /><span class="text-truncate">Albania</span>
                                                </span>
                                            </div>
                                            <div class="tom-select-custom">
                                                <div class="ts-dropdown single js-select form-select plugin-change_listener plugin-hs_smart_position plugin-dropdown_input" style="display: none; visibility: visible; opacity: 1;">
                                                    <div class="dropdown-input-wrap">
                                                        <input
                                                            ...
                                                            id="locationLabel-tomselected"
                                                            aria-activedescendant="locationLabel-opt-3"
                                                        />
                                                    </div>
                                                    <div role="listbox" id="locationLabel-ts-dropdown" tabindex="-1" class="ts-dropdown-content" aria-labelledby="locationLabel-ts-label">
                                                        <span class="d-flex align-items-center option" data-selectable="" data-value="AF" role="option" id="locationLabel-opt-1">
                                                            <img class="avatar avatar-xss avatar-circle me-2" src="assets/vendor/flag-icon-css/flags/1x1/af.svg" alt="Afghanistan Flag" /><span class="text-truncate">Afghanistan</span>
                                                        </span>
                                                        <span class="d-flex align-items-center option" data-selectable="" data-value="AX" role="option" id="locationLabel-opt-2">
                                                            <img class="avatar avatar-xss avatar-circle me-2" src="assets/vendor/flag-icon-css/flags/1x1/ax.svg" alt="Aland Islands Flag" /><span class="text-truncate">Aland Islands</span>
                                                        </span>
                                                        <span class="d-flex align-items-center option selected active" data-selectable="" data-value="AL" role="option" id="locationLabel-opt-3" aria-selected="true">
                                                            <img class="avatar avatar-xss avatar-circle me-2" src="assets/vendor/flag-icon-css/flags/1x1/al.svg" alt="Albania Flag" /><span class="text-truncate">Albania</span>
                                                        </span>
                                                        <span class="d-flex align-items-center option" data-selectable="" data-value="DZ" role="option" id="locationLabel-opt-4">
                                                            <img class="avatar avatar-xss avatar-circle me-2" src="assets/vendor/flag-icon-css/flags/1x1/dz.svg" alt="Algeria Flag" /><span class="text-truncate">Algeria</span>
                                                        </span>
                                                        <span class="d-flex align-items-center option" data-selectable="" data-value="AS" role="option" id="locationLabel-opt-5">
                                                            <img class="avatar avatar-xss avatar-circle me-2" src="assets/vendor/flag-icon-css/flags/1x1/as.svg" alt="American Samoa Flag" /><span class="text-truncate">American Samoa</span>
                                                        </span>
                                                        <span class="d-flex align-items-center option" data-selectable="" data-value="AD" role="option" id="locationLabel-opt-6">
                                                            <img class="avatar avatar-xss avatar-circle me-2" src="assets/vendor/flag-icon-css/flags/1x1/ad.svg" alt="Andorra Flag" /><span class="text-truncate">Andorra</span>
                                                        </span>
                                                        <span class="d-flex align-items-center option" data-selectable="" data-value="AO" role="option" id="locationLabel-opt-7">
                                                            <img class="avatar avatar-xss avatar-circle me-2" src="assets/vendor/flag-icon-css/flags/1x1/ao.svg" alt="Angola Flag" /><span class="text-truncate">Angola</span>
                                                        </span>
                                                        <span class="d-flex align-items-center option" data-selectable="" data-value="AI" role="option" id="locationLabel-opt-8">
                                                            <img class="avatar avatar-xss avatar-circle me-2" src="assets/vendor/flag-icon-css/flags/1x1/ai.svg" alt="Anguilla Flag" /><span class="text-truncate">Anguilla</span>
                                                        </span>
                                                        <span class="d-flex align-items-center option" data-selectable="" data-value="AG" role="option" id="locationLabel-opt-9">
                                                            <img class="avatar avatar-xss avatar-circle me-2" src="assets/vendor/flag-icon-css/flags/1x1/ag.svg" alt="Antigua and Barbuda Flag" /><span class="text-truncate">Antigua and Barbuda</span>
                                                        </span>
                                                        <span class="d-flex align-items-center option" data-selectable="" data-value="AR" role="option" id="locationLabel-opt-10">
                                                            <img class="avatar avatar-xss avatar-circle me-2" src="assets/vendor/flag-icon-css/flags/1x1/ar.svg" alt="Argentina Flag" /><span class="text-truncate">Argentina</span>
                                                        </span>
                                                        <span class="d-flex align-items-center option" data-selectable="" data-value="AM" role="option" id="locationLabel-opt-11">
                                                            <img class="avatar avatar-xss avatar-circle me-2" src="assets/vendor/flag-icon-css/flags/1x1/am.svg" alt="Armenia Flag" /><span class="text-truncate">Armenia</span>
                                                        </span>
                                                        <span class="d-flex align-items-center option" data-selectable="" data-value="AW" role="option" id="locationLabel-opt-12">
                                                            <img class="avatar avatar-xss avatar-circle me-2" src="assets/vendor/flag-icon-css/flags/1x1/aw.svg" alt="Aruba Flag" /><span class="text-truncate">Aruba</span>
                                                        </span>
                                                        <span class="d-flex align-items-center option" data-selectable="" data-value="AU" role="option" id="locationLabel-opt-13">
                                                            <img class="avatar avatar-xss avatar-circle me-2" src="assets/vendor/flag-icon-css/flags/1x1/au.svg" alt="Australia Flag" /><span class="text-truncate">Australia</span>
                                                        </span>
                                                        <span class="d-flex align-items-center option" data-selectable="" data-value="AT" role="option" id="locationLabel-opt-14">
                                                            <img class="avatar avatar-xss avatar-circle me-2" src="assets/vendor/flag-icon-css/flags/1x1/at.svg" alt="Austria Flag" /><span class="text-truncate">Austria</span>
                                                        </span>
                                                        <span class="d-flex align-items-center option" data-selectable="" data-value="AZ" role="option" id="locationLabel-opt-15">
                                                            <img class="avatar avatar-xss avatar-circle me-2" src="assets/vendor/flag-icon-css/flags/1x1/az.svg" alt="Azerbaijan Flag" /><span class="text-truncate">Azerbaijan</span>
                                                        </span>
                                                        <span class="d-flex align-items-center option" data-selectable="" data-value="BS" role="option" id="locationLabel-opt-16">
                                                            <img class="avatar avatar-xss avatar-circle me-2" src="assets/vendor/flag-icon-css/flags/1x1/bs.svg" alt="Bahamas Flag" /><span class="text-truncate">Bahamas</span>
                                                        </span>
                                                        <span class="d-flex align-items-center option" data-selectable="" data-value="BH" role="option" id="locationLabel-opt-17">
                                                            <img class="avatar avatar-xss avatar-circle me-2" src="assets/vendor/flag-icon-css/flags/1x1/bh.svg" alt="Bahrain Flag" /><span class="text-truncate">Bahrain</span>
                                                        </span>
                                                        <span class="d-flex align-items-center option" data-selectable="" data-value="BD" role="option" id="locationLabel-opt-18">
                                                            <img class="avatar avatar-xss avatar-circle me-2" src="assets/vendor/flag-icon-css/flags/1x1/bd.svg" alt="Bangladesh Flag" /><span class="text-truncate">Bangladesh</span>
                                                        </span>
                                                        <span class="d-flex align-items-center option" data-selectable="" data-value="BB" role="option" id="locationLabel-opt-19">
                                                            <img class="avatar avatar-xss avatar-circle me-2" src="assets/vendor/flag-icon-css/flags/1x1/bb.svg" alt="Barbados Flag" /><span class="text-truncate">Barbados</span>
                                                        </span>
                                                        <span class="d-flex align-items-center option" data-selectable="" data-value="BY" role="option" id="locationLabel-opt-20">
                                                            <img class="avatar avatar-xss avatar-circle me-2" src="assets/vendor/flag-icon-css/flags/1x1/by.svg" alt="Belarus Flag" /><span class="text-truncate">Belarus</span>
                                                        </span>
                                                        <span class="d-flex align-items-center option" data-selectable="" data-value="BE" role="option" id="locationLabel-opt-21">
                                                            <img class="avatar avatar-xss avatar-circle me-2" src="assets/vendor/flag-icon-css/flags/1x1/be.svg" alt="Belgium Flag" /><span class="text-truncate">Belgium</span>
                                                        </span>
                                                        <span class="d-flex align-items-center option" data-selectable="" data-value="BZ" role="option" id="locationLabel-opt-22">
                                                            <img class="avatar avatar-xss avatar-circle me-2" src="assets/vendor/flag-icon-css/flags/1x1/bz.svg" alt="Belize Flag" /><span class="text-truncate">Belize</span>
                                                        </span>
                                                        <span class="d-flex align-items-center option" data-selectable="" data-value="BJ" role="option" id="locationLabel-opt-23">
                                                            <img class="avatar avatar-xss avatar-circle me-2" src="assets/vendor/flag-icon-css/flags/1x1/bj.svg" alt="Benin Flag" /><span class="text-truncate">Benin</span>
                                                        </span>
                                                        <span class="d-flex align-items-center option" data-selectable="" data-value="BM" role="option" id="locationLabel-opt-24">
                                                            <img class="avatar avatar-xss avatar-circle me-2" src="assets/vendor/flag-icon-css/flags/1x1/bm.svg" alt="Bermuda Flag" /><span class="text-truncate">Bermuda</span>
                                                        </span>
                                                        <span class="d-flex align-items-center option" data-selectable="" data-value="BT" role="option" id="locationLabel-opt-25">
                                                            <img class="avatar avatar-xss avatar-circle me-2" src="assets/vendor/flag-icon-css/flags/1x1/bt.svg" alt="Bhutan Flag" /><span class="text-truncate">Bhutan</span>
                                                        </span>
                                                        <span class="d-flex align-items-center option" data-selectable="" data-value="BO" role="option" id="locationLabel-opt-26">
                                                            <img class="avatar avatar-xss avatar-circle me-2" src="assets/vendor/flag-icon-css/flags/1x1/bo.svg" alt="Bolivia (Plurinational State of) Flag" />
                                                            <span class="text-truncate">Bolivia (Plurinational State of)</span>
                                                        </span>
                                                        <span class="d-flex align-items-center option" data-selectable="" data-value="BQ" role="option" id="locationLabel-opt-27">
                                                            <img class="avatar avatar-xss avatar-circle me-2" src="assets/vendor/flag-icon-css/flags/1x1/bq.svg" alt="Bonaire, Sint Eustatius and Saba Flag" />
                                                            <span class="text-truncate">Bonaire, Sint Eustatius and Saba</span>
                                                        </span>
                                                        <span class="d-flex align-items-center option" data-selectable="" data-value="BA" role="option" id="locationLabel-opt-28">
                                                            <img class="avatar avatar-xss avatar-circle me-2" src="assets/vendor/flag-icon-css/flags/1x1/ba.svg" alt="Bosnia and Herzegovina Flag" /><span class="text-truncate">Bosnia and Herzegovina</span>
                                                        </span>
                                                        <span class="d-flex align-items-center option" data-selectable="" data-value="BW" role="option" id="locationLabel-opt-29">
                                                            <img class="avatar avatar-xss avatar-circle me-2" src="assets/vendor/flag-icon-css/flags/1x1/bw.svg" alt="Botswana Flag" /><span class="text-truncate">Botswana</span>
                                                        </span>
                                                        <span class="d-flex align-items-center option" data-selectable="" data-value="BR" role="option" id="locationLabel-opt-30">
                                                            <img class="avatar avatar-xss avatar-circle me-2" src="assets/vendor/flag-icon-css/flags/1x1/br.svg" alt="Brazil Flag" /><span class="text-truncate">Brazil</span>
                                                        </span>
                                                        <span class="d-flex align-items-center option" data-selectable="" data-value="IO" role="option" id="locationLabel-opt-31">
                                                            <img class="avatar avatar-xss avatar-circle me-2" src="assets/vendor/flag-icon-css/flags/1x1/io.svg" alt="British Indian Ocean Territory Flag" />
                                                            <span class="text-truncate">British Indian Ocean Territory</span>
                                                        </span>
                                                        <span class="d-flex align-items-center option" data-selectable="" data-value="BN" role="option" id="locationLabel-opt-32">
                                                            <img class="avatar avatar-xss avatar-circle me-2" src="assets/vendor/flag-icon-css/flags/1x1/bn.svg" alt="Brunei Darussalam Flag" /><span class="text-truncate">Brunei Darussalam</span>
                                                        </span>
                                                        <span class="d-flex align-items-center option" data-selectable="" data-value="BG" role="option" id="locationLabel-opt-33">
                                                            <img class="avatar avatar-xss avatar-circle me-2" src="assets/vendor/flag-icon-css/flags/1x1/bg.svg" alt="Bulgaria Flag" /><span class="text-truncate">Bulgaria</span>
                                                        </span>
                                                        <span class="d-flex align-items-center option" data-selectable="" data-value="BF" role="option" id="locationLabel-opt-34">
                                                            <img class="avatar avatar-xss avatar-circle me-2" src="assets/vendor/flag-icon-css/flags/1x1/bf.svg" alt="Burkina Faso Flag" /><span class="text-truncate">Burkina Faso</span>
                                                        </span>
                                                        <span class="d-flex align-items-center option" data-selectable="" data-value="BI" role="option" id="locationLabel-opt-35">
                                                            <img class="avatar avatar-xss avatar-circle me-2" src="assets/vendor/flag-icon-css/flags/1x1/bi.svg" alt="Burundi Flag" /><span class="text-truncate">Burundi</span>
                                                        </span>
                                                        <span class="d-flex align-items-center option" data-selectable="" data-value="CV" role="option" id="locationLabel-opt-36">
                                                            <img class="avatar avatar-xss avatar-circle me-2" src="assets/vendor/flag-icon-css/flags/1x1/cv.svg" alt="Cabo Verde Flag" /><span class="text-truncate">Cabo Verde</span>
                                                        </span>
                                                        <span class="d-flex align-items-center option" data-selectable="" data-value="KH" role="option" id="locationLabel-opt-37">
                                                            <img class="avatar avatar-xss avatar-circle me-2" src="assets/vendor/flag-icon-css/flags/1x1/kh.svg" alt="Cambodia Flag" /><span class="text-truncate">Cambodia</span>
                                                        </span>
                                                        <span class="d-flex align-items-center option" data-selectable="" data-value="CM" role="option" id="locationLabel-opt-38">
                                                            <img class="avatar avatar-xss avatar-circle me-2" src="assets/vendor/flag-icon-css/flags/1x1/cm.svg" alt="Cameroon Flag" /><span class="text-truncate">Cameroon</span>
                                                        </span>
                                                        <span class="d-flex align-items-center option" data-selectable="" data-value="CA" role="option" id="locationLabel-opt-39">
                                                            <img class="avatar avatar-xss avatar-circle me-2" src="assets/vendor/flag-icon-css/flags/1x1/ca.svg" alt="Canada Flag" /><span class="text-truncate">Canada</span>
                                                        </span>
                                                        <span class="d-flex align-items-center option" data-selectable="" data-value="KY" role="option" id="locationLabel-opt-40">
                                                            <img class="avatar avatar-xss avatar-circle me-2" src="assets/vendor/flag-icon-css/flags/1x1/ky.svg" alt="Cayman Islands Flag" /><span class="text-truncate">Cayman Islands</span>
                                                        </span>
                                                        <span class="d-flex align-items-center option" data-selectable="" data-value="CF" role="option" id="locationLabel-opt-41">
                                                            <img class="avatar avatar-xss avatar-circle me-2" src="assets/vendor/flag-icon-css/flags/1x1/cf.svg" alt="Central African Republic Flag" /><span class="text-truncate">Central African Republic</span>
                                                        </span>
                                                        <span class="d-flex align-items-center option" data-selectable="" data-value="TD" role="option" id="locationLabel-opt-42">
                                                            <img class="avatar avatar-xss avatar-circle me-2" src="assets/vendor/flag-icon-css/flags/1x1/td.svg" alt="Chad Flag" /><span class="text-truncate">Chad</span>
                                                        </span>
                                                        <span class="d-flex align-items-center option" data-selectable="" data-value="CL" role="option" id="locationLabel-opt-43">
                                                            <img class="avatar avatar-xss avatar-circle me-2" src="assets/vendor/flag-icon-css/flags/1x1/cl.svg" alt="Chile Flag" /><span class="text-truncate">Chile</span>
                                                        </span>
                                                        <span class="d-flex align-items-center option" data-selectable="" data-value="CN" role="option" id="locationLabel-opt-44">
                                                            <img class="avatar avatar-xss avatar-circle me-2" src="assets/vendor/flag-icon-css/flags/1x1/cn.svg" alt="China Flag" /><span class="text-truncate">China</span>
                                                        </span>
                                                        <span class="d-flex align-items-center option" data-selectable="" data-value="CX" role="option" id="locationLabel-opt-45">
                                                            <img class="avatar avatar-xss avatar-circle me-2" src="assets/vendor/flag-icon-css/flags/1x1/cx.svg" alt="Christmas Island Flag" /><span class="text-truncate">Christmas Island</span>
                                                        </span>
                                                        <span class="d-flex align-items-center option" data-selectable="" data-value="CC" role="option" id="locationLabel-opt-46">
                                                            <img class="avatar avatar-xss avatar-circle me-2" src="assets/vendor/flag-icon-css/flags/1x1/cc.svg" alt="Cocos (Keeling) Islands Flag" /><span class="text-truncate">Cocos (Keeling) Islands</span>
                                                        </span>
                                                        <span class="d-flex align-items-center option" data-selectable="" data-value="CO" role="option" id="locationLabel-opt-47">
                                                            <img class="avatar avatar-xss avatar-circle me-2" src="assets/vendor/flag-icon-css/flags/1x1/co.svg" alt="Colombia Flag" /><span class="text-truncate">Colombia</span>
                                                        </span>
                                                        <span class="d-flex align-items-center option" data-selectable="" data-value="KM" role="option" id="locationLabel-opt-48">
                                                            <img class="avatar avatar-xss avatar-circle me-2" src="assets/vendor/flag-icon-css/flags/1x1/km.svg" alt="Comoros Flag" /><span class="text-truncate">Comoros</span>
                                                        </span>
                                                        <span class="d-flex align-items-center option" data-selectable="" data-value="CK" role="option" id="locationLabel-opt-49">
                                                            <img class="avatar avatar-xss avatar-circle me-2" src="assets/vendor/flag-icon-css/flags/1x1/ck.svg" alt="Cook Islands Flag" /><span class="text-truncate">Cook Islands</span>
                                                        </span>
                                                        <span class="d-flex align-items-center option" data-selectable="" data-value="CR" role="option" id="locationLabel-opt-50">
                                                            <img class="avatar avatar-xss avatar-circle me-2" src="assets/vendor/flag-icon-css/flags/1x1/cr.svg" alt="Costa Rica Flag" /><span class="text-truncate">Costa Rica</span>
                                                        </span>
                                                    </div>
                                                </div>
                                            </div>
                    ...
                    <div class="card-body">
                        <dl class="row">
                            ...
                            <dt class="col-sm-6 text-sm-end">Staff type</dt>
